package com.adventofcode.y2015.input;
...
public class Input {
    ...
    public static List<String> day1() throws IOException {
        return getInputFromFile("/y2015/day1");
    }

    public static List<Box> day2() throws IOException {
        return getInputFromFile("/y2015/day2").stream().map(Box::parse).collect(Collectors.toList());
    }

    public static String day3() throws IOException {
        return String.join("", getInputFromFile("/y2015/day3"));
    }

    public static String day4() throws IOException {
        return String.join("", getInputFromFile("/y2015/day4"));
    }

    public static List<String> day5() throws IOException {
        return getInputFromFile("/y2015/day5");
    }

    public static List<LitInstruction> day6() throws IOException {
        return getInputFromFile("/y2015/day6").
                stream()
                .map(line -> {
                    String operation;
    ...
    public static List<Reindeer> day14() throws IOException {
        ...
        return getInputFromFile("/y2015/day14")
                .stream()
                .map(pattern::matcher)
                .map(matcher -> {
    ...
    public static List<Ingredient> day15() throws IOException {
        ...
        return getInputFromFile("/y2015/day15")
                .stream()
                .map(pattern::matcher)
                .map(matcher -> {
                    if (!matcher.find()) throw new IllegalStateException();
    ...
    public static List<AuntSue> day16() throws IOException {
        return getInputFromFile("/y2015/day16")
                .stream()
                .map(line -> {
    ...
    public static List<Integer> day17() throws IOException {
        return getInputFromFile("/y2015/day17")
                .stream()
    ...
    public static char[][] day18() throws IOException {
        return getInputFromFile("/y2015/day18")
                .stream()
    ...
    public static FusionPlantInput day19() throws IOException {
        List<String> inputFromFile = getInputFromFile("/y2015/day19");
    ...
    public static int day20() throws IOException {
        return Integer.parseInt(getInputFromFile("/y2015/day20").getFirst());
    }

    public static Stats day21() throws IOException {
        List<String> inputFromFile = getInputFromFile("/y2015/day21");
        return new Stats(
    ...
    public static Stats day22() throws IOException {
        List<String> inputFromFile = getInputFromFile("/y2015/day22");
        return new Stats(
                Integer.parseInt(inputFromFile.get(0).split(": ")[1]),
                Integer.parseInt(inputFromFile.get(1).split(": ")[1]),
                0
    ...
    public static List<String> day23() throws IOException {
        return getInputFromFile("/y2015/day23");
    }

    public static List<Integer> day24() throws IOException {
        return getInputFromFile("/y2015/day24").stream().map(Integer::parseInt).collect(Collectors.toList());
    }

    public static RowColumn day25() throws IOException {
        String line = getInputFromFile("/y2015/day25").getFirst();
